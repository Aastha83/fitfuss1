...
public class ExerciseActivity extends AppCompatActivity implements ExerciseRVAdapter.ExerciseClickInterface{
    ...
    {
        exerciseRVModalArrayList.add(new ExerciseRVModal("Side Plank",getResources().getString(R.string.side_plank),R.raw.side_planks,20,10));
        ...
        //will be called when user will clcik on any of the exercise
